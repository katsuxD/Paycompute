...
namespace Paycompute.Services.Implementation
{
    public class PayComputationService : IPayComputationService
    {
        ...
        public decimal ContractualEarnings(decimal contractualHours, decimal hoursWorkded, decimal hourlyRate)
        {
            if (hoursWorkded < contractualHours)
            {
                contractualEarnings = hoursWorkded * hourlyRate;
            }
            else
            {
